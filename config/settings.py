...
# تنظیمات فریم‌ورک Django REST
REST_FRAMEWORK = {
    # روش‌های تشخیص هویت کاربر هنگام دریافت درخواست:
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',    # بررسی توکن در هدر درخواست‌های ارسالی از فلوتر
        'rest_framework.authentication.SessionAuthentication',  # بررسی کوکی‌های مرورگر برای پنل ادمین جنگو
    ],
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'apps.note.pagination.StandardResultsSetPagination',
}
